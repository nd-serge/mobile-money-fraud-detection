...
def get_best_model(experiment_name, tracking_uri):
    """
...
def training_workflow(
    ...
    """
    # Run preprocessing
    run_preprocessing(kaggle_username, kaggle_key, datapath, dest_path)
    # Run training
    run_training(datapath=dest_path, experiment_name=experiment_name, tracking_uri=tracking_uri)
    # Get the best model
    get_best_model(experiment_name=experiment_name, tracking_uri=tracking_uri)
