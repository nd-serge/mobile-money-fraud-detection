...
RUN_ID = e8b480bcb9e646e9bb1080c78d6c1a00 #Change this value
...
start-app:
	...
	docker run --name fraud-detection --network deployment_localstack-network -e AWS_ACCESS_KEY_ID=$(AWS_ACCESS_KEY_ID) \
